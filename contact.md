...
<div class="wrapper">
    ...
    <div class="row">
        <div class="col">
            <br><br>
            <div>
                <a href="https://github.com/andrew-t-williams" style="float: left; margin-right: 10px; margin-top: 4px;">
                    <h1>
                        <span class="iconify" data-icon="octicon:mark-github-16" style="color: white;"></span>
                    </h1>
                </a>
                <pre style="width: calc(100% - 100px); float: left;"><code>github.com/andrew-t-williams</code></pre>
                <a href="https://github.com/andrew-t-williams" style="float:right;">
            ...
            <div>
                <a href="mailto:{{ site.email }}" style="float: left; margin-right: 10px; margin-top: 4px;">
                    <h1>
                        <span class="iconify" data-icon="ant-design:mail-filled" style="color: white;"></span>
                    </h1>
                </a>
                <pre style="width: calc(100% - 100px); float: left;"><code>{{ site.email }}</code></pre>
                <a href="mailto:{{ site.email }}" style="float:right;">
                    <span class="iconify" data-icon="akar-icons:link-out" style="color: white; height: 25px; width: 25px; margin-top: 6px;"></span>
                </a>
            </div>
            <div>
                <a href="tel:{{ site.phone }}" style="float: left; margin-right: 10px; margin-top: 4px;">
                    <h1>
                        <span class="iconify" data-icon="clarity:mobile-phone-solid" style="color: white;"></span>
                    </h1>
                </a>
                <pre style="width: calc(100% - 100px); float: left;"><code>{{ site.phone }}</code></pre>
                <a href="tel:{{ site.phone }}" style="float:right;">
                    <span class="iconify" data-icon="akar-icons:link-out" style="color: white; height: 25px; width: 25px; margin-top: 6px;"></span>
                </a>
            </div>
            <div>
            ...
            <div>
                <a href="" style="float: left; margin-right: 10px; margin-top: 4px;">
                    <h1>
                        <span class="iconify" data-icon="icon-park-outline:id-card-v" style="color: white;"></span>
                    </h1>
                </a>
                <pre style="width: calc(100% - 100px); float: left;"><code>Résumé</code></pre>
